...
import javaFoundations4thEd.ch3.RandomNumbers;
...
public class InkBlot {
    ...
    public void generateInkBlot() {
        RandomWalk x = new RandomWalk(150,0,300);
        RandomWalk y = new RandomWalk(150,0,300);
        ...
        for(int i = 0; i < 15000; i++){
            Line a = advance(x,y);
            a.setStrokeColor(getColor(red,green,blue));
            canvas.add(a);
            canvas.add(mirror(a));
        }
    }
